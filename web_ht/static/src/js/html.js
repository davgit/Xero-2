openerp.web_ht = function (openerp) {

var _t = openerp.web._t,
   _lt = openerp.web._lt;
var QWeb = openerp.web.qweb;

openerp.web.views.add('ht', 'openerp.web.HtmlView');
openerp.web.HtmlView = openerp.web.View.extend( /** @lends openerp.web.FormView# */{
    /**
    ...
    searchable: false,
    readonly : false,
    form_template: "HtmlView",
    display_name: _lt('Htmls'),
    /**
     ...
     *
     * @property {openerp.web.Registry} registry=openerp.web_ht.widgets widgets registry for this form view instance
     */
    init: function(parent, dataset, view_id, options) {
        ...
        this.registry = openerp.web_ht.widgets;
...
openerp.web_ht.compute_domain = function(expr, fields) {
    var stack = [];
...
openerp.web_ht.Widget = openerp.web.OldWidget.extend(/** @lends openerp.web_ht.Widget# */{
    template: 'Widget',
    /**
     * @constructs openerp.web_ht.Widget
    ...
    process_modifiers: function() {
        var compute_domain = openerp.web_ht.compute_domain;
...
openerp.web_ht.WidgetFrame = openerp.web_ht.Widget.extend({
...
openerp.web_ht.WidgetGroup = openerp.web_ht.WidgetFrame.extend({
    template: 'WidgetGroup'
}),

openerp.web_ht.WidgetNotebook = openerp.web_ht.Widget.extend({
...
openerp.web_ht.WidgetNotebookPage = openerp.web_ht.WidgetFrame.extend({
...
openerp.web_ht.WidgetSeparator = openerp.web_ht.Widget.extend({
...
openerp.web_ht.WidgetButton = openerp.web_ht.Widget.extend({
...
openerp.web_ht.WidgetLabel = openerp.web.form.Widget.extend({
...
openerp.web_ht.Field = openerp.web.form.Widget.extend(/** @lends openerp.web_ht.Field# */{
    /**
     * @constructs openerp.web_ht.Field
     * @extends openerp.web_ht.Widget
     *
     * @param view
     * @param node
     */
...
openerp.web_ht.FieldChar = openerp.web_ht.Field.extend({
    template: 'FieldChar',
    init: function (view, node) {
        this._super(view, node);
...
openerp.web_ht.FieldID = openerp.web_ht.FieldChar.extend({
    update_dom: function() {
        this._super.apply(this, arguments);
...
openerp.web_ht.FieldEmail = openerp.web_ht.FieldChar.extend({
    template: 'FieldEmail',
    start: function() {
        this._super.apply(this, arguments);
...
openerp.web_ht.FieldUrl = openerp.web_ht.FieldChar.extend({
    template: 'FieldUrl',
    start: function() {
        this._super.apply(this, arguments);
        this.$element.find('button').click(this.on_button_clicked);
...
openerp.web_ht.FieldFloat = openerp.web_ht.FieldChar.extend({
    init: function (view, node) {
        this._super(view, node);
...
openerp.web_ht.FieldDatetime = openerp.web_ht.Field.extend({
...
openerp.web_ht.FieldDate = openerp.web_ht.FieldDatetime.extend({
    build_widget: function() {
        return new openerp.web.DateWidget(this);
    }
});

openerp.web_ht.FieldText = openerp.web_ht.Field.extend({
    template: 'FieldText',
    start: function() {
        this._super.apply(this, arguments);
...
openerp.web_ht.FieldBoolean = openerp.web_ht.Field.extend({
...
openerp.web_ht.FieldProgressBar = openerp.web_ht.Field.extend({
...
openerp.web_ht.FieldTextXml = openerp.web_ht.Field.extend({
// to replace view editor
});

openerp.web_ht.FieldSelection = openerp.web_ht.Field.extend({
...
openerp.web_ht.dialog = function(content, options) {
    options = _.extend({
        width: '90%',
        height: 'auto',
        min_width: '800px'
...
openerp.web_ht.FieldMany2One = openerp.web_ht.Field.extend({
        ...
        var init_context_menu_def = $.Deferred().then(function(e) {
            ...
            rdataset.call("get", ['action', 'client_action_relate',
                ...
                bindings[self.cm_id + "_open"] = function() {
                    ...
                    var pop = new openerp.web_ht.FormOpenPopup(self.view);
                    pop.show_element(
                        self.field.relation,
                        self.value[0],
                        self.build_context(),
    ...
    _search_create_popup: function(view, ids, context) {
        var self = this;
        var pop = new openerp.web_ht.SelectCreatePopup(this);
        pop.select_element(
            self.field.relation,
            {
...
openerp.web_ht.FieldOne2Many = openerp.web_ht.Field.extend({
    ...
    start: function() {
        ...
        this.dataset = new openerp.web_ht.One2ManyDataSet(this, this.field.relation);
    ...
    load_views: function() {
        ...
        this.viewmanager.registry = openerp.web.views.extend({
            list: 'openerp.web_ht.One2ManyListView',
            form: 'openerp.web_ht.One2ManyFormView',
...
openerp.web_ht.One2ManyDataSet = openerp.web.BufferedDataSet.extend({
...
openerp.web_ht.One2ManyListView = openerp.web.ListView.extend({
    ...
    do_activate_record: function(index, id) {
        var self = this;
        var pop = new openerp.web_ht.FormOpenPopup(self.o2m.view);
...
openerp.web_ht.One2ManyFormView = openerp.web.FormView.extend({
...
openerp.web_ht.FieldMany2Many = openerp.web_ht.Field.extend({
    ...
    start: function() {
        ...
        this.dataset = new openerp.web_ht.Many2ManyDataSet(this, this.field.relation);
    ...
    load_view: function() {
        var self = this;
        this.list_view = new openerp.web_ht.Many2ManyListView(this, this.dataset, false, {
...
openerp.web_ht.Many2ManyDataSet = openerp.web.DataSetStatic.extend({
    get_context: function() {
 ...
 */
openerp.web_ht.Many2ManyListView = openerp.web.ListView.extend(/** @lends openerp.web_ht.Many2ManyListView# */{
    do_add_record: function () {
        var pop = new openerp.web_ht.SelectCreatePopup(this);
        pop.select_element(
            this.model,
    ...
    do_activate_record: function(index, id) {
        var self = this;
        var pop = new openerp.web_ht.FormOpenPopup(this);
 ...
 * @extends openerp.web.OldWidget
 */
openerp.web_ht.SelectCreatePopup = openerp.web.OldWidget.extend(/** @lends openerp.web_ht.SelectCreatePopup# */{
    ...
    select_element: function(model, options, domain, context) {
        ...
        this.render_element();
        openerp.web_ht.dialog(this.$element, {
            close: function() {
                self.check_exit();
            },
            title: options.title || ""
    ...
    setup_search_view: function(search_defaults) {
        ...
        this.searchview.on_loaded.add_last(function () {
            self.view_list = new openerp.web_ht.SelectCreateListView(self,
                    self.dataset, false,
...
openerp.web_ht.SelectCreateListView = openerp.web.ListView.extend({
    do_add_record: function () {
 ...
 * @extends openerp.web.OldWidget
 */
openerp.web_ht.FormOpenPopup = openerp.web.OldWidget.extend(/** @lends openerp.web_ht.FormOpenPopup# */{
    ...
    start: function() {
        this._super();
        this.dataset = new openerp.web_ht.FormOpenDataset(this, this.model, this.context);
...
openerp.web_ht.FormOpenDataset = openerp.web.ProxyDataSet.extend({
    read_ids: function() {
...
openerp.web_ht.FieldReference = openerp.web_ht.Field.extend({
    ...
    init: function(view, node) {
        ...
        this.fields = {};
        this.fields_order = [];
        this.selection = new openerp.web_ht.FieldSelection(this, { attrs: {
            name: 'selection',
            widget: 'selection'
        }});
        this.reference_ready = true;
        this.selection.on_value_changed.add_last(this.on_selection_changed);
        this.m2o = new openerp.web_ht.FieldMany2One(this, { attrs: {
            name: 'm2o',
            widget: 'many2one'
        }});
...
openerp.web_ht.FieldBinary = openerp.web_ht.Field.extend({
    init: function(view, node) {
        this._super(view, node);
...
openerp.web_ht.FieldBinaryFile = openerp.web_ht.FieldBinary.extend({
...
openerp.web_ht.FieldBinaryImage = openerp.web_ht.FieldBinary.extend({
...
openerp.web_ht.FieldStatus = openerp.web_ht.Field.extend({
    template: "EmptyComponent",
    start: function() {
        this._super();
...
openerp.web_ht.WidgetHtml = openerp.web_ht.Widget.extend({
    render: function () {
 ...
 */
openerp.web_ht.widgets = new openerp.web.Registry({
    'frame' : 'openerp.web_ht.WidgetFrame',
    'group' : 'openerp.web_ht.WidgetGroup',
    'notebook' : 'openerp.web_ht.WidgetNotebook',
    'notebookpage' : 'openerp.web_ht.WidgetNotebookPage',
    'separator' : 'openerp.web_ht.WidgetSeparator',
    'label' : 'openerp.web_ht.WidgetLabel',
    'button' : 'openerp.web_ht.WidgetButton',
    'char' : 'openerp.web_ht.FieldChar',
    'id' : 'openerp.web_ht.FieldID',
    'email' : 'openerp.web_ht.FieldEmail',
    'url' : 'openerp.web_ht.FieldUrl',
    'text' : 'openerp.web_ht.FieldText',
    'date' : 'openerp.web_ht.FieldDate',
    'datetime' : 'openerp.web_ht.FieldDatetime',
    'selection' : 'openerp.web_ht.FieldSelection',
    'many2one' : 'openerp.web_ht.FieldMany2One',
    'many2many' : 'openerp.web_ht.FieldMany2Many',
    'one2many' : 'openerp.web_ht.FieldOne2Many',
    'one2many_list' : 'openerp.web_ht.FieldOne2Many',
    'reference' : 'openerp.web_ht.FieldReference',
    'boolean' : 'openerp.web_ht.FieldBoolean',
    'float' : 'openerp.web_ht.FieldFloat',
    'integer': 'openerp.web_ht.FieldFloat',
    'float_time': 'openerp.web_ht.FieldFloat',
    'progressbar': 'openerp.web_ht.FieldProgressBar',
    'image': 'openerp.web_ht.FieldBinaryImage',
    'binary': 'openerp.web_ht.FieldBinaryFile',
    'statusbar': 'openerp.web_ht.FieldStatus',
    'html': 'openerp.web_ht.WidgetHtml'
});
